package www.test720.a360video.base;
...
import www.test720.a360video.network.ApiService;
import www.test720.a360video.network.HttpsRequest;
import www.test720.a360video.uitls.ActivityUtil;
import www.test720.a360video.uitls.ClickEventUtils;
import www.test720.a360video.uitls.KeyBoardUtils;
import www.test720.a360video.uitls.SizeUtils;
...
public abstract class BaseToolbarActivity extends AppCompatActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		apiService = HttpsRequest.Companion.provideClientApi();
		initView();
		initData();
		setListener();
	}
